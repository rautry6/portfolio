...
function CitizenTable({ citizenData }: ITableProps) {
    ...
    const columns = ['FIRST NAME', 'LAST NAME', 'ID', 'COUNTRY', 'CAN TRAVEL']
                ...
                <TableHead>
                    <TableRow>
                        {columns.map((header: string) => (
                            <TableCell className="Header" key={header} align="center">
                                {header}
                            </TableCell>
                        ))}
                    </TableRow>
                ...
                <TableBody>
                    {citizenData.map((person: Citizen) => (
                        <TableRow key={person.idNumber}>
                            ...
                            <TableCell
                                className={person.canTravel ? 'CanTravel' : 'NoTravel'}
                                align="center"
                            >
                                {person.canTravel ? 'YES' : 'NO'}
                            </TableCell>
                        </TableRow>
                    ))}
                </TableBody>
