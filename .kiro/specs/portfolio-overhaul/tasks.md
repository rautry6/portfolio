...
- [ ] 2. Phase 2 — Data Layer
  ...
  - [ ] 2.3 Create `src/data/projects/_template.js`
    ...
    - _Requirements: 5.3_
  - [ ] 2.4 Extract each project into its own `src/data/projects/<ProjectName>.js` module
  ...
  - [ ] 2.5 Create `src/data/projectRegistry.js`
  ...
  - [ ]* 2.6 Write property test for schema conformance (Property 1)
  ...
  - [ ] 2.7 Verify build is still clean (data layer only, no component changes yet)
    - Run `npm run build` and confirm it exits 0
    - _Requirements: 1.6_

- [ ] 3. Phase 3 — Component Split
  - [ ] 3.1 Create `src/components/ProjectGrid.jsx`
  ...
  - [ ]* 3.2 Write property test for registry-driven rendering (Property 2)
  ...
  - [ ]* 3.3 Write property test for stable keys (Property 3)
  ...
  - [ ] 3.4 Refactor `Projects.js` to use the registry and `ProjectGrid`
  ...
  - [ ] 3.7 Verify visual parity after component split
    - Run `npm run build` and confirm it exits 0
    - Manually verify the main page renders both project tabs correctly
    - _Requirements: 3.5_

- [ ] 4. Checkpoint — Ensure all tests pass after Phase 3
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Phase 4 — ProjectPage Props
  - [ ] 5.1 Update `ProjectPage.js` to destructure `location.state` and pass explicit props
    ...
    - _Requirements: 4.7_
  - [ ] 5.2 Update `ProjectBanner`, `ProjectInfo`, and `ProjectImages` to accept named props
    ...
    - _Requirements: 4.7_
  - [ ]* 5.3 Write property test for explicit props round-trip (Property 4)
...
- [ ] 6. Phase 5 — Code Quality Pass
  ...
  - [ ] 6.2 Add `alt` attributes to all informational `<img>` elements
    ...
    - _Requirements: 4.4_
  - [ ]* 6.3 Write property test for image alt text (Property 5)
    - Use `fast-check` to generate arbitrary `ProjectData` objects
  ...
  - [ ] 6.4 Replace index-based `key` props with stable identifiers
    ...
    - _Requirements: 4.2_
  - [ ] 6.5 Remove dead imports and fix remaining `useEffect` dependency arrays
